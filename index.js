...
class DatArchive {
  ...
  static async create ({localPath, localPathTemplate, datOptions = {}, netOptions, title, description, type, author}) {
    if (localPathTemplate) {
      ...
      datOptions.options = datOptions.options || {}
      datOptions.options.secretKey = secretKey
    ...
    // create the dat
    var archive = new DatArchive(null, {localPath, datOptions, netOptions, publicKey, secretKey})
